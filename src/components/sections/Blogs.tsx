...
import { HiSearch, HiBookOpen, HiTag, HiCalendar, HiTerminal, HiArrowRight, HiChevronDown } from "react-icons/hi";
                            ...
                            <section key={year} className="relative">
                                <div className="sticky top-20 z-20 py-2 mb-4 bg-[#0A0A12]/80 backdrop-blur-md">
                                    <div className="flex items-center gap-4 px-2">
                                        <h2 className="text-sm font-black font-mono text-blue-500 uppercase tracking-[0.3em]">{year}</h2>
                                                        ...
                                                        <div className="flex flex-wrap gap-x-3 gap-y-1 mt-1">
                                                            ...
                                                            <div className="flex gap-2">
                                                                {post.tags.slice(0, 3).map(tag => (
                                                                    <span key={tag} className="text-[9px] font-mono text-blue-400/50 uppercase">
                                                                        #{tag.toLowerCase()}
                                                                    </span>
                                                                ))}
                                                            </div>
